...
body_t *disappearing_platform(vector_t center, char *info) {
    ...
    body_t *disappearing_platform = make_platform(center, DISAPPEARING_COLOR, info, DISAPPEARING_DIMENSIONS.x, DISAPPEARING_DIMENSIONS.y, sprite);
...
body_t *trick_platform(vector_t center, char *info) {
    ...
    body_t *trick_platform = make_platform(center, DISAPPEARING_COLOR, info, TRICK_DIMENSIONS.x, TRICK_DIMENSIONS.y, sprite);
