...
STUDENT_LIBS = vector star list polygon body scene forces force_aux force_package collision text platforms sprite game_sprites test_util preferences powerups
